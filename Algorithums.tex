...
\part{Fundamentals}
\label{sec:org3840a0c}
\chapter{Summary of topics}
\label{sec:org9a76d76}
\begin{itemize}
...
\end{itemize}
\section{Subheading}
\label{sec:orgbb6a7a1}
\chapter{Data Abstraction}
\label{sec:org61e8f63}
\begin{itemize}
...
\label{sec:orgacd7f28}
\chapter{Case Study: Union-Find}
\label{sec:org8329f7d}

\part{Sorting}
\label{sec:org73a5e52}
\chapter{Elementary Sorts}
\label{sec:org3456c0a}
\chapter{Merge Sort}
\label{sec:org810d109}
\end{document}
